    ...
    <div class="container-fluid">
            ...
            <div class="sk-container">
                  <section class="contacthero">
                    ...
                    <p>Let’s discuss your project goals. Send us a quick message or request a callback for a friendly, practical conversation.</p>
            </section>
            ...
            <section class="contactform">
                    <div class="contact-bento-grid">
                                ...
                                <form class="wd-lead-form" action="/contact/" method="get">
                                   <div>
                                    ...
                                    <div>
                                       ...
                                       <textarea id="message" name="message" rows="3" placeholder="Anything you’d like me to know before we talk?"></textarea>
                                    </div>
                        ...
                        <div class="action-card consultation-card">
                            <img src="<?php echo BASE_PATH; ?>/public/icons/meeting.webp" width="52" alt="Calendar"> <!-- better icon -->
                        ...
                        <div class="self-contact-card">
                            ...
                            <img src="<?php echo BASE_PATH; ?>/public/img/js.jpg" alt="Jatinder Singh" class="profile-img">
                            ...
                            <a href="mailto:hello@slashkode.com.au">hello@slashkode.com.au</a>
